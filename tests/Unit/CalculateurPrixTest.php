...
class CalculateurPrixTest extends TestCase
{
    ...
    public function test_calcul_prix_avec_taxe_negative_leve_exception(): void
    {
        ...
        $calculateur->calculerAvecTaxe(100.00, -0.15); // Taxe négative
    }
    ...
    public function test_remise_negative_leve_exception(): void
    {
        $calculateur = new CalculateurPrix;
        $this->expectException(InvalidArgumentException::class);
        $resultat = $calculateur->appliquerRemise(10.00, -5.00); // remise négative
    }
    ...
    public function test_seuil_negatif_leve_exception(): void
    {
        $calculateur = new CalculateurPrix;
        $this->expectException(InvalidArgumentException::class);
        $calculateur->respecteSeuilMinimum(100.00, -50.00); // remise négative
    }
    ...
    {
        $calculateur = new CalculateurPrix;
        $this->assertTrue($calculateur->respecteSeuilMinimum(15.00, 10.00));
        $this->assertFalse($calculateur->respecteSeuilMinimum(10.00, 15.00));
    }
}
